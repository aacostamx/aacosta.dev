...
export default {
  ...
  methods: {
    onSubmit() {
      ...
      axios
        .post(
          "https://t2uil6smp8.execute-api.us-east-1.amazonaws.com/production/message-me/test",
          {
            email: this.email,
        ...
        .catch(() => {
          this.response =
            "Looks like there is an issue while submitting the form. Please send me an email at antonio@aacosta.dev";
        });
    }
  }
};
